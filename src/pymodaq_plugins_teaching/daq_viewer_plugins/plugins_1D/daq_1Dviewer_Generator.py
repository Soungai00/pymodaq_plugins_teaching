...
class DAQ_1DViewer_Generator(DAQ_Viewer_base):
    ...
    params = comon_parameters+[
        ...
        {'title': 'Waveform:', 'name': 'waveform', 'type': 'list', 'limits': WaveType.names(), 'value': WaveType.SINUS},
        {'title': 'Frequency (Hz):', 'name': 'freq', 'type': 'float', 'value': 10.},
        {'title': 'Amplitude (V):', 'name': 'amplitude', 'type': 'float', 'value': 1.},
        {'title': 'Offset', 'name': 'offset', 'type': 'float', 'value': 0.},
        {'title': 'Phase:', 'name': 'frequency', 'type': 'float', 'value': 0.}
